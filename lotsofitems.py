...
item1 = Item(user_id=1, name="Socker Boots",
                             description="Shoes to play socker",
                             categories=category1)
session.add(item1)
session.commit()

item2 = Item(user_id=1, name="Basket ball",
                             description="A ball to play basket",
                             categories=category2)
session.add(item2)
session.commit()

item3 = Item(user_id=1, name="Surf board",
...
item5 = Item(user_id=1, name="Running shoes",
...
item8 = Item(user_id=1, name="Harnesses",
                             description="To practice rock climbing",
                             categories=category8)
session.add(item8)
session.commit()

item9 = Item(user_id=1, name="Pilates ball",
